#################################
##  Version 2.0.0 October 10, 2021 Junji Sugiyama 
##  RegakuRapid2 application: coversion to cartesian coordinate then peak fitting for MFA / crystallinity measurements
#################################
